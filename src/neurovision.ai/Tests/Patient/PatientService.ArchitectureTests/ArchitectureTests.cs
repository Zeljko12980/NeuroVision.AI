...
namespace PatientService.ArchitectureTests;

public class LayerDependencyTests
{
    private static readonly System.Reflection.Assembly Domain = typeof(Patient).Assembly;
    private static readonly System.Reflection.Assembly Application = typeof(CreatePatientCommand).Assembly;
    private static readonly System.Reflection.Assembly Infrastructure = typeof(DependencyInjection).Assembly;
    private static readonly System.Reflection.Assembly Api = typeof(PatientController).Assembly;
    ...
    public void Infrastructure_ShouldNotDependOn_Api()
    {
        Types.InAssembly(Infrastructure)
            .ShouldNot()
            .HaveDependencyOn("PatientService.API")
            .GetResult()
            .ShouldBeSuccessful();
    }
    ...
    public void Application_ShouldDependOn_Domain()
    {
        Types.InAssembly(Application)
            .That()
            .HaveName("CreatePatientCommandHandler")
            .Should()
            .HaveDependencyOn("PatientService.Domain")
            .GetResult()
            .ShouldBeSuccessful();
    }
}
...
public class NamingConventionTests
{
    ...
    public void ApplicationInterfaces_ShouldResideIn_CommonInterfaces()
    {
        Types.InAssembly(Application)
            ...
            .AreInterfaces()
            .Should()
            .ResideInNamespace("PatientService.Application.Common.Interfaces")
            .GetResult()
            .ShouldBeSuccessful();
    }
    ...
    public void Handlers_ShouldResideIn_ApplicationFeature()
    {
        Types.InAssembly(Application)
            ...
            .Should()
            .ResideInNamespaceContaining("PatientService.Application.Feature")
            .GetResult()
            .ShouldBeSuccessful();
    }
    ...
    public void WriteStore_ShouldBeImplemented_InInfrastructurePersistence()
    {
        Types.InAssembly(Infrastructure)
            .That()
            .ImplementInterface(typeof(IPatientWriteStore))
            .Should()
            .ResideInNamespace("PatientService.Infrastructure.Persistence")
            .GetResult()
            .ShouldBeSuccessful();
    }
    ...
    public void FileStorage_ShouldBeImplemented_InInfrastructureServices()
    {
        Types.InAssembly(Infrastructure)
            ...
            .Should()
            .ResideInNamespace("PatientService.Infrastructure.Services")
            .GetResult()
            .ShouldBeSuccessful();
    }
...
public class ControllerConventionTests
{
    ...
    public void Controllers_ShouldDependOn_MediatR_NotInfrastructurePersistence()
    {
        ...
        Types.InAssembly(Api)
            ...
            .HaveNameEndingWith("Controller")
            .ShouldNot()
            .HaveDependencyOn("PatientService.Infrastructure.Persistence")
            .GetResult()
            .ShouldBeSuccessful();
    }
}
