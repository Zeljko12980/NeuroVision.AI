...
export default function UserDropdown() {
    ...
    const { name: userName, email: userEmail, role: userRole } =
        getUserInfoFromClaims(claims || {});

    const isSuperAdmin = userRole === "SuperAdministrator";
        ...
        <div className="relative">
            ...
            >
                ...
                <Link
                    ...
                    className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg text-theme-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5"
                >
                    Sign out
                </Link>
            </Dropdown>
