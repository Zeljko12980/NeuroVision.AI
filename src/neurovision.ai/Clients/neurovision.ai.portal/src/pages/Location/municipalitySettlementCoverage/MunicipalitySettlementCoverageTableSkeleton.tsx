...
interface MunicipalitySettlementCoverageTableSkeletonProps {
    rows?: number;
}

export default function MunicipalitySettlementCoverageTableSkeleton({
    rows = 5,
}: MunicipalitySettlementCoverageTableSkeletonProps) {
    return (
        <>
