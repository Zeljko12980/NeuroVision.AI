...
interface RegionSettlementCoverageTableSkeletonProps {
    rows?: number;
}

export default function RegionSettlementCoverageTableSkeleton({
    rows = 5,
}: RegionSettlementCoverageTableSkeletonProps) {
    return (
        <>
