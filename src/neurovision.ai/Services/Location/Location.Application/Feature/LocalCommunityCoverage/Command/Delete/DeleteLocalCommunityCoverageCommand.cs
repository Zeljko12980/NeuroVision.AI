...
public sealed class DeleteLocalCommunityCoverageCommandValidator : AbstractValidator<DeleteLocalCommunityCoverageCommand>
{
    public DeleteLocalCommunityCoverageCommandValidator()
    {
